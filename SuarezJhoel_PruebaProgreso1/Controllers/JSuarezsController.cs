...
namespace SuarezJhoel_PruebaProgreso1.Controllers
{
    public class JSuarezsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Correo,DineroDisponibloe,Donante_de_organos,FechaNaciemiento,IdCelular")] JSuarez jSuarez)
        {
            ...
            ViewData["IdCelular"] = new SelectList(_context.Celular, "Id", "Modelo", jSuarez.IdCelular);
            return View(jSuarez);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Correo,DineroDisponibloe,Donante_de_organos,FechaNaciemiento,IdCelular")] JSuarez jSuarez)
        {
            if (id != jSuarez.Id)
            {
                return NotFound();
